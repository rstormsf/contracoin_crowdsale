  ...
  describe('finalizing the crowdsale', function() {
    ...
    describe('when the goal is reached', function() {
      ...
      it('handles goal reached', async function () {
        ...
        let foundersBalance = await this.token.balanceOf(foundersTimelockAddress);
        ...
        let foundationBalance = await this.token.balanceOf(foundationTimelockAddress);
        ...
        let partnersBalance = await this.token.balanceOf(partnersTimelockAddress);
